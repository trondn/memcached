...
ENGINE_ERROR_CODE assoc_init(struct arc_engine *engine) {
...
hash_item *assoc_find(struct arc_engine *engine, uint32_t hash, const char *key, const size_t nkey) {
    hash_item *it;
...
static hash_item** _hashitem_before(struct arc_engine *engine,
                                    uint32_t hash,
                                    const char *key,
                                    const size_t nkey) {
    hash_item **pos;
...
static void assoc_expand(struct arc_engine *engine) {
...
int assoc_insert(struct arc_engine *engine, uint32_t hash, hash_item *it) {
    unsigned int oldbucket;
...
void assoc_delete(struct arc_engine *engine, uint32_t hash, const char *key, const size_t nkey) {
